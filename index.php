...
<div class="menu-area">
    <div id="dl-menu" class="dl-menuwrapper">
        ...
        <ul class="dl-menu">
            ...
            <li><a href="#works">Importances</a></li>

            <li><a href="#team">Notre équipe</a></li>
            <li><a href="#part">Nos partenaires</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="color-light">
                    <h2 class="wow bounceInDown" data-wow-delay="1s"></h2>
                    <h4></h4>
                </div>
            </div>
        </div>
...
<section id="part" class="home-section bg-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <div class="section-heading">
...
<section id="contact" class="home-section bg-white">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <div id="sendmessage">Votre message à bien été envoyé !</div>
                <div id="errormessage"></div>
                <form action="" method="post" role="form" class="contactForm">
                    <div class="form-group">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Votre nom"
                               data-rule="minlen:4" data-msg="Entrez au moins 4 charactères"/>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control" name="email" id="email" placeholder="Email"
                               data-rule="email" data-msg="Entrez une adresse valide"/>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="subject" id="subject" placeholder="Sujet"
                               data-rule="minlen:4" data-msg="Entrez au moins 8 charactères"/>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" name="message" rows="5" data-rule="required"
                                  data-msg="Ecrivez nous quelque chose !" placeholder="Message"></textarea>
                        <div class="validation"></div>
                    </div>
